      ...
      <div className='flex flex-col'>
        ...
        <div className='lg:w-full p-6 flex flex-col justify-center'>
          ...
          <div className='flex items-center justify-between mb-4'>
            <span className='text-md font-light bg-black/70 text-white rounded px-3 py-1'>${product.price.toLocaleString()}</span>
            <div className='text-xs py-1 px-2 border-1 border-neutral-400 rounded-lg font-bold'>{product.rarity}</div>
          </div>
