...
import { featurizeProduct } from '@/app/lib/actions';
          ...
          products.map((p) => {
            return (
              <div
                ...
                key={p.id}
                className={`
                  bg-white shadow-md max-h-[450px]
              ...
              >
                ...
                {clickedFeature === p.id ? (
                    ...
                    <span className='flex w-full mb-2 items-center justify-between'>
                      <input
                        ...
                        <button
                          ...
                          className={`
                            ${allowedToFeaturize ? 'bg-green-500 shadow-2xl shadow-green-400 text-black hover:bg-black hover:text-white active:bg-red-700 hover:cursor-pointer' : 'hover:cursor-not-allowed bg-neutral-500 text-white'}
                  ...
                  <button
                    ...
                    className={`
                      rounded-lg p-2 bg-yellow-100 shadow-md w-11/12 mt-3
