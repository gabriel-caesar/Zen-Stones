...
export default function ProductCard({
  ...
  return (
    <>
      ...
      <Carousel product={product} height={`h-[272px] ${isQuery && 'md:border-b-1'}`} />
      ...
      <div id='card-features-wrapper' className={`p-2 ${isQuery && 'md:border-b-1 md:border-l-1'}`}>
        {/* Product name */}
        ...
        {/* Product description */}
        <p
          className={`${isQuery ? 'hidden' : 'block'} text-neutral-500 text-sm max-h-20 overflow-y-auto mb-5 break-all`}
        ...
        <div
          className={`${isQuery ? 'hidden' : 'flex'} items-center justify-between px-2 text-sm text-gray-500`}
