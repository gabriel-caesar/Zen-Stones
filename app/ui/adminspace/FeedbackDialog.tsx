  ...
  return (
    <>
      {(params) && (
        <div 
          className={`
            ${params !== 'true' ? 'bg-red-500' : 'bg-green-500'}
            flex flex-col items-center justify-center rounded-lg p-2 z-3
            shadow-2xl w-3/4 py-10 border border-neutral-700 md:w-1/2 lg:w-1/4 fixed top-1/5
          `}
        >
          <h1 className='text-center'>
            {params !== 'true' ? 'Something went wrong' : text}
          </h1>
          <button
